...
// DRAM_MTPS/DRAM_DBUS_RETURN_TIME/tRP/tRCD/tCAS are now per-instance
// members of MEMORY_CONTROLLER (see inc/dram_controller.h), set via
// set_timing() -- no longer global. main.cc calls set_timing() on each
// MEMORY_CONTROLLER instance instead of assigning these as globals.
